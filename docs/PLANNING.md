> **Archived planning doc.** This was the original README, written before
> the pipeline was actually run/tested and before the dataset builder was
> renamed to Hiraeth-Forge. Kept here for history. See the current
> [README.md](../README.md) for what's actually implemented and verified.
